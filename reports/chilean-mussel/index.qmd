...
description: "Genome-wide DNA methylation patterns in Mytilus chilensis from two contrasting seedbeds reveal a system-wide epigenetic response associated with local adaptation."
categories: [mussels, genomics, epigenetics, aquaculture, DNA methylation]
...
topic:
  ...
  - epigenetics
  - aquaculture
github_repo: "https://github.com/sr320/paper-chilean-mussel"
data_url: ""
...
Source data, analysis code, and the original manuscript site are available at the project repository: <https://github.com/sr320/paper-chilean-mussel> (rendered at <https://sr320.github.io/paper-chilean-mussel/>).

## Suggested citation

Gallardo, C., Venezuala, V., and Roberts, S. B. 2025. *DNA methylation in Mytilus chilensis: Epigenetic mechanisms of local adaptation*. Current Findings. Available at: https://robertslab.github.io/current-findings/reports/chilean-mussel/

## Version history

| Version | Date | Notes |
|---|---|---|
| 1.0 | 2025-08-12 | Original manuscript (standalone site) |
| 1.1 | 2026-06-17 | Migrated into Current Findings |
