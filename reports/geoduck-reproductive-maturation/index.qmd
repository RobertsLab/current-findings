---
title: "Characterization of Reproductive Maturation in Geoduck Clams (Panopea generosa)"
...
description: "Fine-scale histological staging of 70 geoduck gonad samples from November 2014 to January 2015 documents reproductive maturation and its variation over time."
categories: [reproduction, histology, aquaculture, geoduck, shellfish]
status: "Not peer reviewed"
report_type: "Working manuscript"
lab: "Roberts Lab"
project: "Geoduck reproductive maturation"
species:
  - Panopea generosa
topic:
...
github_repo: ""
data_url: "https://figshare.com/articles/dataset/Reproductive_Maturation_in_Geoduck_clams_Panopea_generosa_/3205975"
format:
  html:
    toc: true
...
Once the histology slides were returned, the tissue samples were sexed and categorized into stages of sexual development. The sex was determined by examination of the histology slides for the presence of either oocytes or spermatids. After the samples were sexed, each sex was further examined to create parameters for reproductive ripeness. For females, the parameters were average secondary (2°) oocyte size (µ) and estimated average follicle size (µ). For males, the parameters were percentage of tissue composed of acini and percentage of acini composed of spermatids. Using these parameters, stages of development were established (@tbl-female-stages, @tbl-male-stages).

: Staging parameters for female geoducks. Parameters were determined after examining the histology slides (proxy for the individual geoducks themselves) and categorizing the slides into stages, based on estimated average follicle size and estimated average oocyte size, representing different degrees of reproductive ripeness. {#tbl-female-stages}
...
A total of 70 histology slides were examined. The sexes of the geoduck sample tissues were determined through the presence of either oocytes or spermatids. Then, within sexes, the individual slides were placed into a reproductive stage of development (@tbl-female-results, @tbl-male-results), according to the parameters as shown in @tbl-female-stages and @tbl-male-stages. Representative images for each reproductive stage are presented in @fig-female-histology and @fig-male-histology.

After the histology slides were categorized, the geoduck weight and length data was revisited to investigate if there was any correlation between geoduck size and reproductive stage. Geoduck weight and length were compared separately across the reproductive stages in each sex, and no apparent correlations were found between either characteristic and the geoduck ripeness in each stage (@fig-female-weight, @fig-male-weight, @fig-female-length, @fig-male-length). Then, the proportion of geoduck clams at each stage of reproductive development per each sampling week was analyzed for each sex (@fig-female-proportions, @fig-male-proportions). A general trend of increasing reproductive ripeness over time was demonstrated for both sexes from November to January. There were some variations, however, with Stage 4 geoducks in both males and females showing up before Stage 3. Also, Stage 1 geoducks for both sexes appeared in December.

: Results of female sex-determination of histology slides and placement into reproductive stages. The number after "Geo-" represents the order in which the geoduck was sampled from week one. Specimens marked with ** were incorrectly fixed; there are likely a few more than those marked, but they were not discernible from the correctly fixed tissues. {#tbl-female-results}
...
: Results of male sex-determination of histology slides and placement into reproductive stages. The number after "Geo-" represents the order in which the geoduck was sampled from week one. Specimens marked with ** were incorrectly fixed; there are likely a few more than those marked, but they were not discernible from the correctly fixed tissues. {#tbl-male-results}
...
![Representative images at 10× (left image) and 40× (right image) magnification for each female reproductive stage. Each slide is labeled with the same format: f = female; G## = the geoduck tissue specimen number; s# = the stage number; ##x = the magnification at which the image was captured.](figures/fig-female-histology.png){#fig-female-histology}

![Representative images at 10× (left image) and 40× (right image) magnification for each male reproductive stage. Each slide is labeled with the same format: m = male; G## = the geoduck tissue specimen number; s# = the stage number; ##x = the magnification at which the image was captured.](figures/fig-male-histology.png){#fig-male-histology}

![Average geoduck weight (g) per reproductive stage in females. There is no clear correlation between average weight and reproductive stage.](figures/fig-female-weight.png){#fig-female-weight}

![Average geoduck weight (g) per reproductive stage in males. There is no clear correlation between average weight and reproductive stage.](figures/fig-male-weight.png){#fig-male-weight}

![Average geoduck length per reproductive stage in females. There is no clear correlation between average length and reproductive stage.](figures/fig-female-length.png){#fig-female-length}

![Average geoduck length per reproductive stage in males. There is no clear correlation between average length and reproductive stage.](figures/fig-male-length.png){#fig-male-length}

![The proportion of female geoducks at each reproductive stage across the sampling weeks. There was a general trend of increasing reproductive ripeness as time progressed, with some variation: Stage 4 geoducks appear before Stage 3, and Stage 1 geoducks reappear in December.](figures/fig-female-proportions.png){#fig-female-proportions}

![The proportion of male geoducks at each reproductive stage across the sampling weeks. There was a general trend of increasing reproductive ripeness as time progressed, with some variation: Stage 4 geoducks appear before Stage 3, and Stage 1 geoducks reappear in December.](figures/fig-male-proportions.png){#fig-male-proportions}

## Discussion

These results were more or less what was expected. As time progresses, the reproductive ripeness increases for both sexes. However, @fig-female-proportions and @fig-male-proportions demonstrate the variability in reproductive maturation rates. In both figures, the Stage 1 geoduck clams make a reappearance in December. Also, in both sexes, Stage 3 geoducks appear after all or the majority of Stage 4 geoducks appear. These results verify the conditions that aquaculturists are experiencing, as these variations in reproductive maturation rates could result in the variations in timing of spawning and could also be the cause of some geoducks not spawning at all if they mature very slowly.

During dissection, it was clear how anatomically indistinguishable one geoduck was from the next, solidifying through first-hand experience that these animals would be impossible to sex through superficial examination. This was further supported through @fig-female-weight through @fig-male-length, which indicate no apparent correlation between weight or length and reproductive stage at this time scale. However, these averages may be skewed due to variable numbers of geoduck individuals per reproductive stage, but that could not be controlled as there currently is no method of sexing geoducks without dissection.
...
The reproductive maturation dataset for this study is archived on figshare: [Reproductive Maturation in Geoduck clams (*Panopea generosa*)](https://figshare.com/articles/dataset/Reproductive_Maturation_in_Geoduck_clams_Panopea_generosa_/3205975).
